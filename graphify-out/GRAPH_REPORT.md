# Graph Report - Veridia-Saber-Admin  (2026-05-09)

## Corpus Check
- 142 files · ~148,099 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 832 nodes · 1280 edges · 73 communities (54 shown, 19 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 12 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `50c67c20`
...
2. `supabase` - 43 edges
3. `📊 Tabelas` - 20 edges
4. `Decisões Arquiteturais — Veridia Saber Admin` - 15 edges
5. `StrategyHandler` - 14 edges
6. `📁 /src — Código Fonte Principal` - 14 edges
7. `PrecacheController` - 13 edges
8. `Veridia Saber — Painel Administrativo` - 13 edges
9. `📁 /src/components — Componentes React` - 12 edges
10. `Router` - 11 edges
...
- `FamilyModal()` --calls--> `useAuth()`  [EXTRACTED]
  src/components/Modals/FamilyModal.tsx → src/contexts/AuthContext.tsx

## Communities (73 total, 19 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.07
Nodes (27): Family, Species, StatCard(), StatCardProps, ConfirmDeleteModal(), ConfirmDeleteModalProps, FamilyModal(), PendingCuratorshipModal() (+19 more)
...
Cohesion: 0.07
Nodes (32): FamilyLegacyNamesSection(), FamilyLegacyNamesSectionProps, FamilyLegacyName, useFamilyLegacyNames(), UseFamilyLegacyNamesReturn, useSpeciesForm(), ExistingImage, UploadOptions (+24 more)
...
Cohesion: 0.16
Nodes (14): ExistingImage, UploadOptions, useSpecimenImages(), UseSpecimenImagesReturn, INITIAL_FORM, Specimen, SpecimenFormData, useSpecimens() (+6 more)
...
Cohesion: 0.16
Nodes (15): SpeciesPage(), GLOBAL_ROLES, isGlobalRole(), Profile, Project, Users(), UserStats, useSpecies() (+7 more)
...
Cohesion: 0.28
Nodes (5): executeQuotaErrorCallbacks(), StrategyHandler, timeout(), toRequest(), waitUntil()

### Community 14 - "Community 14"
Cohesion: 0.12
Nodes (15): code:block1 (├── .env                          # Variáveis de ambiente (V), code:block26 (supabase/), code:block27 (public/), code:block28 (docs/), 🎯 Conceitos Importantes, 📁 /Contratos — Contratos e Documentos Legais, 📁 /docs — Documentação, Espécie vs Espécime (+7 more)

### Community 15 - "Community 15"
Cohesion: 0.12
Nodes (16): code:block10 (src/services/), code:block12 (src/database/), code:block2 (src/), code:block3 (src/assets/), code:block5 (src/config/), code:block6 (src/contexts/), code:block8 (src/routes/), code:block9 (src/hooks/) (+8 more)
...
Cohesion: 0.19
Nodes (9): Specimens(), useAuth(), DashboardLayout(), MENU_ITEMS, MenuItem, Sidebar(), OnlyGlobalAdmin(), PrivateRoute() (+1 more)
...
Cohesion: 0.13
Nodes (15): Cards, code:block15 (src/components/Cards/), code:block16 (src/components/Dashboard/), code:block18 (src/components/Forms/), code:block19 (src/components/Layout/), code:block20 (src/components/Maps/), code:block22 (src/components/ProjectDetails/), code:block24 (src/components/Modals/) (+7 more)
...
Cohesion: 0.21
Nodes (6): AuditLog, ContentItem, ORGAOS, PASTAS_ARQUIVOS, RichTextEditorProps, supabase
...
Cohesion: 0.24
Nodes (8): canManage(), getRoleConfig(), RoleConfig, RoleDisplayInfo, ROLES_LIST, UserProfile, config, passesMinLevel
...
Cohesion: 0.22
Nodes (7): ExistingImage, ImageUploadZone(), ImageUploadZoneProps, Species, SpeciesModalProps, STAGE_LABEL, UploadStage

### Community 31 - "Community 31"
Cohesion: 0.33
Nodes (6): INITIAL_FORM, speciesRepo, specimenRepo, Species, Specimen, SpecimenFilters
...
Cohesion: 0.25
Nodes (5): AuthContext, AuthContextType, AuthProvider(), adminRouter, publicRouter
...
Cohesion: 0.33
Nodes (5): FamilyOption, Species, SpeciesStats, UseSpeciesOptions, UseSpeciesReturn
...
Cohesion: 0.4
Nodes (3): FamilyOption, LabelDataTabProps, LocalData

### Community 50 - "Community 50"
Cohesion: 0.4
Nodes (5): Admin (Autenticado), code:block13 (src/pages/admin/), code:block14 (src/pages/landingpage/), Landing Page (Público), 📁 /src/pages — Páginas da Aplicação

## Knowledge Gaps
- **354 isolated node(s):** `corsHeaders`, `supabaseClient`, `RichTextEditorProps`, `ImageData`, `GroupedImages` (+349 more)
...
- **Why does `supabase` connect `Community 22` to `Community 0`, `Community 4`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 16`, `Community 20`, `Community 26`, `Community 28`, `Community 30`, `Community 31`, `Community 32`, `Community 33`, `Community 35`, `Community 36`, `Community 39`, `Community 44`, `Community 46`?**
  _High betweenness centrality (0.105) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 17` to `Community 0`, `Community 4`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 16`, `Community 18`, `Community 20`, `Community 24`, `Community 25`, `Community 30`, `Community 31`, `Community 32`, `Community 33`, `Community 35`, `Community 36`, `Community 44`, `Community 46`?**
